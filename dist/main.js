 ...
 * are typing.
 * To get around this problem, place a `<KeyboardSpace />` at the bottom
 ...
 */
const KeyboardSpace = () => (
  Platform.OS === 'ios' ? <KeyboardSpaceIOS /> : null
);

class KeyboardSpaceIOS extends Component<Props, Props, State> {
  static propTypes = {
